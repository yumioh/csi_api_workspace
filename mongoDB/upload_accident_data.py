...
read_raw_data = pd.read_excel(kosha_file)
...
if isinstance(json_raw_data, list):
    accident_document.insert_many(json_raw_data) # 배열형태의 다수의 데이터를 삽입
else:
    accident_document.insert_one(json_raw_data) # 단일 document 
