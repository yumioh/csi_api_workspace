...
#공사규모
axis(1, at=colMeans(bp), labels=c("9명이하","10~99명이하","100~499명이하","500명이하"), cex.axis = 0.8)

#발생시간
axis(1, at=colMeans(bp), labels=c("0~6시","6~8시","8~12시","12~13시","13~18시","18~21시","21~24시"), cex.axis = 0.8)

#근무경력 x축 레이블 추가
axis(1, at=colMeans(bp), labels=c("1년미만","1~2년미만","2~3년미만","3~4년미만","4~5년미만","5~10년미만","10년이상"), cex.axis = 0.8)
